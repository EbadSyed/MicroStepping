...
void loop() {
    ...
    if (prints == 1){
      ...
      Serial.println("1 for 22.5 degrees");
      Serial.println("2 for 60 degrees");
      Serial.println("3 for 100 degrees");
      Serial.println("4 for 120 degrees");
      Serial.println("5 for -22.5 degrees");
      Serial.println("6 for -60 degrees");
      Serial.println("7 for -100 degrees");
      Serial.println("8 for -120 degrees");
      Serial.println();
      Serial.println();
    ...
    if (Serial.available() > 0) {
      ...
      if (val == '1'){
        stepper.rotate(22.5);
        Serial.println("Moving 22.5 degrees");
      }
      else if (val == '2'){
        stepper.rotate(60);
        Serial.println("Moving 60 degrees");  
      }
      else if (val == '3'){
        stepper.rotate(100);
        Serial.println("Moving 100 degrees");  
      }
      else if (val == '4'){
        stepper.rotate(120);
        Serial.println("Moving 120 degrees");  
      }
      else if (val == '5'){
        stepper.rotate(-22.5);
        Serial.println("Moving -22.5 degrees");  
